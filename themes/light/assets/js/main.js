...
// indiquer la page sur laquelle on est par un effet sur l'item du menu en desktop (done!)
// espacer les rubriques (en cours)
// home: faire une home avec un récap de toutes les autres rubriques (voir avec Pao)
// revoir le CSS de l'affichage des membres (en cours)
// scinder la page "qui sommes nous" en une page "membres+histoire" et "infos contacts" (done)
